...
function showState(state) {
    ...
    const hero = document.querySelector(".about-hero--cart");
    if (content)
        content.hidden = state !== "content";
    if (empty)
        empty.hidden = state !== "empty";
    if (thankyou)
        thankyou.hidden = state !== "thankyou";
    if (hero)
        hero.hidden = state !== "content";
}
// ---- RENDER -------------------------------------------------
/**
...
function renderCartItems(cart) {
    ...
    cart.forEach((item) => {
      ...
      <button class="cart__item-remove" data-id="${item.id}" aria-label="Remove item">
    ...
    container
        ...
        .forEach((btn) => {
        btn.addEventListener("click", () => { var _a; return handleRemoveItem((_a = btn.dataset.id) !== null && _a !== void 0 ? _a : ""); });
    });
}
/**
...
function handleQuantityChange(btn) {
    var _a;
    const id = (_a = btn.dataset.id) !== null && _a !== void 0 ? _a : "";
...
function initCart() {
    ...
    renderCart();
    (_a = document
        .getElementById("clear-cart-btn")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", handleClearCart);
    (_b = document
        .getElementById("checkout-btn")) === null || _b === void 0 ? void 0 : _b.addEventListener("click", handleCheckout);
}
